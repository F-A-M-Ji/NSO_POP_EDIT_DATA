...
from PyQt5.QtWidgets import QMainWindow, QStackedWidget, QMessageBox
from PyQt5.QtCore import Qt
from PyQt5.QtGui import QFont, QIcon  # แก้ไข: เพิ่มการ import QIcon
...
from .admin_menu_screen import AdminMenuScreen
from .reset_password_screen import ResetPasswordScreen
from frontend.utils.resource_path import resource_path # แก้ไข: เพิ่มการ import resource_path
...
class MainApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # ตรวจสอบให้แน่ใจว่าคุณมีไฟล์ app_icon.png ในโฟลเดอร์ assets
