...
#         text_block_rect = QRect(rect.x(), rect.y(), rect.width(), rect.height())
#         text_drawing_rect = text_block_rect.adjusted(
...
#             main_text_rect_height = text_drawing_rect.height()
#             if subText:
#                 main_text_rect_height = (
#                     int(text_drawing_rect.height() * 0.6)
#                     - self.VERTICAL_PADDING_PER_LINE // 2
#                 )

#             main_text_draw_rect = QRect(
#                 text_drawing_rect.x(),
#                 text_drawing_rect.y(),
#                 text_drawing_rect.width(),
#                 main_text_rect_height,
#             )
#             painter.drawText(
#                 main_text_draw_rect, Qt.AlignCenter | Qt.TextWordWrap, mainText
#             )
...
#             sub_text_y_start = text_drawing_rect.y()
#             if mainText:
#                 sub_text_y_start += (
#                     int(text_drawing_rect.height() * 0.6)
#                     + self.VERTICAL_PADDING_PER_LINE // 2
...
#             sub_text_rect_height = text_drawing_rect.height() - (
#                 sub_text_y_start - text_drawing_rect.y()
#             )

#             sub_text_draw_rect = QRect(
#                 text_drawing_rect.x(),
#                 sub_text_y_start,
#                 text_drawing_rect.width(),
#                 sub_text_rect_height,
#             )

#             painter.drawText(
#                 sub_text_draw_rect, Qt.AlignCenter | Qt.TextWordWrap, subText
#             )
